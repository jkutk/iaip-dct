 ...
 * absolute values of the mat, giving distinct colors red/blue according to the
 * sign of the original mat value
 */
public class LogRedBlue implements MatFilter {
	/*
	 * (non-Javadoc)
	 * 
